...
import zipkin2.Span;
import zipkin2.translation.zipkin.SpanTranslator.LocalInetAddressSupplier;
...
public class SpanTranslatorTest {
   ...
   */
  @Test
  void translate_clientOtelSpan() throws UnknownHostException {
    SpanTranslator.LocalInetAddressSupplier.setInstance(new LocalInetAddressSupplier(InetAddress.getByName("172.28.0.100")));
    ...
    ExportTraceServiceRequest request = ExportTraceServiceRequest.newBuilder()
        .addResourceSpans(ResourceSpans.newBuilder()
            ...
            .addScopeSpans(ScopeSpans.newBuilder()
                .addSpans(io.opentelemetry.proto.trace.v1.Span.newBuilder()
                    .setSpanId(ByteString.fromHex("5b4185666d50f68b"))
                    .setTraceId(ByteString.fromHex("7180c278b62e8f6a216a2aea45d08fc9"))
                    .setParentSpanId(ByteString.fromHex("6b221d5bc9e6496c"))
                    .setName("get")
                    .setKind(SpanKind.SPAN_KIND_CLIENT)
                    .setStartTimeUnixNano(TimeUnit.SECONDS.toNanos(1))
                    .setEndTimeUnixNano(TimeUnit.SECONDS.toNanos(1) + 123_456_000)
    ...
    List<zipkin2.Span> translated = SpanTranslator.translate(request);

    assertThat(translated).hasSize(1);
    assertThat(translated.get(0))
        .isEqualTo(
                Span.newBuilder()
                    .traceId("7180c278b62e8f6a216a2aea45d08fc9")
                    .parentId("6b221d5bc9e6496c")
                    ...
                    .name("get")
                    .kind(Span.Kind.CLIENT)
                    .localEndpoint(Endpoint.newBuilder().serviceName("frontend").ip("172.28.0.100").build())
                    .remoteEndpoint(
                        Endpoint.newBuilder()
                            .serviceName("backend")
                            .ip("192.168.99.101")
                    ...
                    .putTag("links[0].spanId", "6c5295666d50f69c")
                    .putTag("links[0].tags[foo]", "bar")
                    .putTag("net.sock.peer.addr", "192.168.99.101")
                    .putTag("net.sock.peer.name", "backend")
                    .putTag("net.sock.peer.port", "9000")
                    .putTag("otel.library.name", "zipkin2.reporter.otel")
                    .putTag("otel.library.version", "0.0.1")
                    .putTag("otel.scope.name", "zipkin2.reporter.otel")
                    .putTag("otel.scope.version", "0.0.1")
                    .shared(false)
                    .build());
  }
