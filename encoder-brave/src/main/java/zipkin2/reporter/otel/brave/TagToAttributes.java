 ...
 *
 * @see <a href=
 * "https://opentelemetry.io/docs/specs/semconv/http/http-spans/">https://opentelemetry.io/docs/specs/semconv/http/http-spans/</a>
...
public final class TagToAttributes implements MutableSpan.TagConsumer<Span.Builder> {
	...
	public static final class Builder {
		...
		/**
		 * Covert brave <code>http.url</code> tag to otel attributes
		 * (<code>url.path</code>, <code>url.query</code> and
		 * <code>url.fragment</code>).<br>
		 * If the <code>http.url</code> includes the schema part (mostly client side),
		 * <code>url.full</code> and <code>url.schema</code> will be added.
		 */
		private static final TagToAttribute URL_TAG_TO_ATTRIBUTE = (spanBuilder, value) -> {
			try {
				...
				// map URI parts to "stable" attributes as of OpenTelemetry Semantic
				// Conventions 1.29.0
		 ...
		 * <td>See {@link #URL_TAG_TO_ATTRIBUTE}</td>
		 * </tr>
		 * <tr>
		...
		public Builder withDefaults() {
			...
			return this.tagToAttribute(HttpTags.METHOD, SemanticConventionsAttributes.HTTP_REQUEST_METHOD)
		...
		/**
		 * Set a simple 1:1 mapping from a brave tag key to an otel attribute name with
		 * the same value.
		 */
