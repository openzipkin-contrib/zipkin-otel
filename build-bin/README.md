...
The Docker image for zipkin-otel is a layer over zipkin, including only the [../module] and configuration settings.

As zipkin-otel is a contrib project, Docker images only push to ghcr.io.
