...
class ProtoUtilsTest {
	...
	void testValueToJson() {
		...
		assertThat(valueToJson(AnyValue.newBuilder()
		...
		assertThat(valueToJson(AnyValue.newBuilder()
			.setKvlistValue(KeyValueList.newBuilder()
				...
				.build())
			.build())).isEqualTo("{\"x\":\"abc\",\"y\":\"efg\",\"z\":0}");
	...
	void testKvListToJson() {
		assertThat(kvListToJson(Arrays.asList(
				KeyValue.newBuilder().setKey("string").setValue(AnyValue.newBuilder().setStringValue("s")).build(),
